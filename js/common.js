const navbarHTML = `
<nav class="base-secondary-section top-section bg-secondary-selected">
  <h1 class="font-bold" style="font-size: 4vh;">
    <a href="index.html" class="hover:underline">G's Lore</a>
  </h1>
...
const footerHTML = `
<footer class="text-center text-sm text-gray-400 mt-10 p-10 base-secondary-section mt-auto">
