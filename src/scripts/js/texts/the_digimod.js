document.getElementById("td-lore").innerHTML = `
    <p>
      ...
      <!-- TD-ABOUT-COUNTS:START (generated by src/scripts/sync_td_roster.py, do not hand-edit) -->It currently adds 263 digimon, with 284 more already modeled and being worked into the mod.<!-- TD-ABOUT-COUNTS:END -->
    </p>
    <p>
      The Digimod is developed together with the community on our
      <a href="https://discord.gg/EeNkjGZY37" target="_blank" rel="noopener noreferrer" class="wiki-link">Discord</a>,
      where anyone can help by modeling new digimon. All the models still to be built,
      claimed, or already finished are tracked on
      <a href="https://trello.com/b/Z5gjWmkN/the-digimod-needed-models" target="_blank" rel="noopener noreferrer" class="wiki-link">this Trello board</a>.
    </p>
  `;
